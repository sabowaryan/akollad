...
const NavLink: React.FC<{ href: string; children: React.ReactNode; onClick: () => void }> = ({ href, children, onClick }) => (
  <a
    href={href}
    onClick={onClick}
    className="block md:inline-block px-3 py-2 text-gray-300 hover:text-[#C9A96E] transition-colors duration-300 relative group text-xs tracking-widest uppercase font-semibold"
  >
    {children}
